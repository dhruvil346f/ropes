/* global versatileBusinessScreenReaderText */
/**
...
(function($) {
    ...
    function initMainNavigation(container) {
        ...
        var dropdownToggle = $('<button />', {
            ...
            .append(versatileBusinessScreenReaderText.icon)
            .append($('<span />', {
                'class': 'screen-reader-text',
                text: versatileBusinessScreenReaderText.expand
            }));
        ...
        container.find('.current-menu-ancestor > button')
            ...
            .text(versatileBusinessScreenReaderText.collapse);
        ...
        container.find('.dropdown-toggle').click(function(e) {
            ...
            // jscs:enable
            screenReaderSpan.text(screenReaderSpan.text() === versatileBusinessScreenReaderText.expand ? versatileBusinessScreenReaderText.collapse : versatileBusinessScreenReaderText.expand);
        });
    }
    ...
    (function() {
        ...
        menuToggle.on('click.versatileBusiness', function() {
    ...
    (function() {
        ...
        function toggleFocusClassTouchScreen() {
            if (window.innerWidth >= 910) {
                $(document.body).on('touchstart.versatileBusiness', function(e) {
                    if (!$(e.target).closest('.main-navigation li').length) {
                        $('.main-navigation li').removeClass('focus');
                    }
                });
                siteNavigation.find( '.menu-item-has-children > a, .page_item_has_children > a' ).on( 'touchstart.versatileBusiness', function( e ) {
                ...
                siteNavigation.find('.menu-item-has-children > a').unbind('touchstart.versatileBusiness');
            }
        }

        if ('ontouchstart' in window) {
            $(window).on('resize.versatileBusiness', toggleFocusClassTouchScreen);
            toggleFocusClassTouchScreen();
        }

        siteNavigation.find('a').on('focus.versatileBusiness blur.versatileBusiness', function() {
    ...
    $(document).ready(function() {
        $(window)
            .on('load.versatileBusiness resize.versatileBusiness', function() {
                if (window.innerWidth < 910) {
